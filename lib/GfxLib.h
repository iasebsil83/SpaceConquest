...
void triangle(float xCoin1,float yCoin1, float xCoin2,float yCoin2, float xCoin3,float yCoin3, bool full);

/* Dessine un rectangle de couleur courante aux coordonnees donnees */
void rectangle(float xCoin1,float yCoin1, float xCoin2,float yCoin2, bool full);

// ================================ HERE IS ADDED =================================
void quad(float x1,float y1, float x2,float y2, float x3,float y3, float x4,float y4);
void circle(float centreX, float centreY, float R, bool complete, bool full); //complete ? M_2PI : M_PI

void afficheNombre(int nbr, float taille, float x, float y);
// ================================================================================
